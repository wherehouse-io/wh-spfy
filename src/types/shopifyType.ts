...
declare class ShopifyTypes {
  constructor(
    config:
      | ShopifyTypes.IPublicShopifyConfig
      | ShopifyTypes.IPrivateShopifyConfig
  );
  ...
  applicationCharge: {
    activate: (
      id: number,
      params?: any
    ) => Promise<ShopifyTypes.IApplicationCharge>;
    create: (
      params: ShopifyTypes.ICreateApplicationCharge
    ) => Promise<ShopifyTypes.IApplicationCharge>;
    get: (id: number, params?: any) => Promise<ShopifyTypes.IApplicationCharge>;
    list: (
      params?: any
    ) => Promise<
      ShopifyTypes.IPaginatedResult<ShopifyTypes.IApplicationCharge>
    >;
  };
  applicationCredit: {
    create: (
      params: ShopifyTypes.ICreateApplicationCredit
    ) => Promise<ShopifyTypes.IApplicationCredit>;
  ...
  article: {
    ...
    create: (
      blogId: number,
      params: ShopifyTypes.ICreateArticle
    ) => Promise<ShopifyTypes.IArticle>;
    ...
    list: (
      blogId: number,
      params?: any
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.IArticle>>;
    tags: (blogId?: number, params?: any) => Promise<string[]>;
    update: (
      blogId: number,
      id: number,
      params: ShopifyTypes.IUpdateArticle
    ) => Promise<ShopifyTypes.IArticle>;
  };
  asset: {
    ...
    update: (
      themeId: number,
      params: ShopifyTypes.IUpdateAsset
    ) => Promise<ShopifyTypes.IAsset>;
  };
  balance: {
    ...
    transactions: (
      ...
      ShopifyTypes.IPaginatedResult<ShopifyTypes.IBalanceTransaction>
    >;
  };
  blog: {
    ...
    list: (
      params?: any
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.IBlog>>;
  ...
  cancellationRequest: {
    create: (
      ...
      message?: string
    ) => Promise<ShopifyTypes.IFulfillmentOrder>;
    accept: (
      fulfillmentOrderId: number,
      message?: string
    ) => Promise<ShopifyTypes.IFulfillmentOrder>;
  ...
  carrierService: {
    create: (
      params: ShopifyTypes.ICreateCarrierService
    ) => Promise<ShopifyTypes.ICarrierService>;
    delete: (id: number) => Promise<void>;
    get: (id: number) => Promise<ShopifyTypes.ICarrierService>;
    list: () => Promise<ShopifyTypes.ICarrierService[]>;
    update: (
      id: number,
      params: ShopifyTypes.IUpdateCarrierService
    ) => Promise<ShopifyTypes.ICarrierService>;
  };
  checkout: {
    ...
    list: (
      params?: any
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.ICheckout>>;
  ...
  collect: {
    count: (params?: any) => Promise<number>;
    create: (
      params: ShopifyTypes.ICreateCollect
    ) => Promise<ShopifyTypes.ICollect>;
    delete: (id: number) => Promise<void>;
    get: (id: number, params?: any) => Promise<ShopifyTypes.ICollect>;
    list: (
      params?: any
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.ICollect>>;
  };
  collection: {
    ...
    products: (
      id: number,
      params?: any
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.IProduct>>;
  };
  collectionListing: {
    ...
    list: (
      ...
      ShopifyTypes.IPaginatedResult<ShopifyTypes.ICollectionListing>
    >;
  ...
  comment: {
    ...
    count: (params?: any) => Promise<number>;
    create: (
      params: ShopifyTypes.ICreateComment
    ) => Promise<ShopifyTypes.IComment>;
    get: (id: number, params?: any) => Promise<ShopifyTypes.IComment>;
    list: (
      params?: any
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.IComment>>;
    ...
    update: (
      id: number,
      params: ShopifyTypes.IUpdateComment
    ) => Promise<ShopifyTypes.IComment>;
  };
  country: {
    count: () => Promise<number>;
    create: (
      params: ShopifyTypes.ICreateCountry
    ) => Promise<ShopifyTypes.ICountry>;
    delete: (id: number) => Promise<void>;
    get: (id: number, params?: any) => Promise<ShopifyTypes.ICountry>;
    list: (params?: any) => Promise<ShopifyTypes.ICountry[]>;
    update: (
      id: number,
      params: ShopifyTypes.IUpdateCountry
    ) => Promise<ShopifyTypes.ICountry>;
  };
  currency: {
  ...
  customCollection: {
    ...
    list: (
      params?: any
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.ICustomCollection>>;
    update: (
      id: number,
      params: any
    ) => Promise<ShopifyTypes.ICustomCollection>;
  };
  customer: {
    ...
    list: (
      params?: any
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.ICustomer>>;
    search: (
      params: any
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.ICustomer>>;
    sendInvite: (
      id: number,
      params?: ShopifyTypes.ICustomerSendInvite
    ) => Promise<ShopifyTypes.ICustomerSendInvite>;
  ...
  customerAddress: {
    create: (
      customerId: number,
      params: any
    ) => Promise<ShopifyTypes.ICustomerAddress>;
    default: (
      customerId: number,
      id: number
    ) => Promise<ShopifyTypes.ICustomerAddress>;
    ...
    list: (
      customerId: number,
      params?: any
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.ICustomerAddress>>;
  ...
  customerSavedSearch: {
    ...
    get: (
      id: number,
      params?: any
    ) => Promise<ShopifyTypes.ICustomerSavedSearch>;
    list: (
      params?: any
    ) => Promise<
      ShopifyTypes.IPaginatedResult<ShopifyTypes.ICustomerSavedSearch>
    >;
    update: (
      id: number,
      params: any
  ...
  discountCode: {
    create: (
      priceRuleId: number,
      params: any
    ) => Promise<ShopifyTypes.IDiscountCode>;
    ...
    list: (
      priceRuleId: number,
      params?: any
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.IDiscountCode>>;
  ...
  discountCodeCreationJob: {
    create: (
      priceRuleId: number,
      params: any[]
    ) => Promise<ShopifyTypes.IDiscountCodeCreation>;
  ...
  dispute: {
    ...
    list: (
      params?: any
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.IDispute>>;
  };
  disputeEvidence: {
    get: (disputeId: number) => Promise<ShopifyTypes.IDisputeEvidence>;
    update: (
      disputeId: number,
      params: ShopifyTypes.IUpdateDisputeEvidence
    ) => Promise<ShopifyTypes.IDisputeEvidence>;
  };
  disputeFileUpload: {
    create: (
      disputeId: number,
      params: ShopifyTypes.ICreateDisputeFileUpload
    ) => Promise<ShopifyTypes.IDisputeFileUpload>;
    delete: (id: number) => Promise<void>;
  };
  draftOrder: {
    ...
    list: (
      params?: any
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.IDraftOrder>>;
  ...
  event: {
    ...
    list: (
      params?: any
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.IEvent>>;
  };
  fulfillment: {
    ...
    complete: (
      orderId: number,
      id: number
    ) => Promise<ShopifyTypes.IFulfillment>;
    ...
    list: (
      orderId: number,
      params?: any
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.IFulfillment>>;
  ...
  fulfillmentEvent: {
    create: (
      ...
      params: any
    ) => Promise<ShopifyTypes.IFulfillmentEvent>;
    delete: (
      orderId: number,
      fulfillmentId: number,
      id: number
  ...
  fulfillmentOrder: {
    cancel: (
      id: number,
      params: ShopifyTypes.IFulfillmentOrder
    ) => Promise<ShopifyTypes.IFulfillmentOrder>;
    close: (
      id: number,
      message?: string
    ...
    setFulfillmentOrdersDeadline: (
      params: ShopifyTypes.ISetFulfillmentOrdersDeadline
    ) => Promise<void>;
    fulfillments: (
      id: number
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.IFulfillment>>;
  ...
  fulfillmentRequest: {
    ...
    create: (
      fulfillmentOrderId: number,
      params: ShopifyTypes.ICreateFulfillmentRequest
    ) => Promise<ShopifyTypes.IFulfillmentOrder>;
    reject: (
      fulfillmentOrderId: number,
      message?: string
  ...
  fulfillmentService: {
    ...
    update: (
      id: number,
      params: any
    ) => Promise<ShopifyTypes.IFulfillmentService>;
  };
  giftCard: {
    count: (params?: any) => Promise<number>;
    ...
    list: (
      params?: any
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.IGiftCard>>;
    search: (
      params: any
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.IGiftCard>>;
  ...
  giftCardAdjustment: {
    create: (
      giftCardId: number,
      params: any
    ) => Promise<ShopifyTypes.IGiftCardAdjustment>;
    get: (
      giftCardId: number,
      id: number
    ) => Promise<ShopifyTypes.IGiftCardAdjustment>;
  ...
  inventoryItem: {
    ...
    list: (
      params?: any
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.IInventoryItem>>;
  ...
  inventoryLevel: {
    ...
    list: (
      params: any
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.IInventoryLevel>>;
  ...
  location: {
    ...
    inventoryLevels: (
      id: number,
      params?: any
    ) => Promise<ShopifyTypes.IInventoryLevel[]>;
  ...
  marketingEvent: {
    ...
    list: (
      params?: any
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.IMarketingEvent>>;
  ...
  metafield: {
    ...
    list: (
      params?: any
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.IMetafield>>;
    update: (id: number, params: any) => Promise<ShopifyTypes.IMetafield>;
  };
  on(
    event: "callLimits",
    callback: (limits: ShopifyTypes.ICallLimits) => void
  ): ShopifyTypes;
  on(
    event: "callGraphqlLimits",
    callback: (limits: ShopifyTypes.ICallGraphqlLimits) => void
  ): ShopifyTypes;
  order: {
    ...
    list: (
      params?: any
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.IOrder>>;
  ...
  orderRisk: {
    ...
    list: (
      orderId: number
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.IOrderRisk>>;
    update: (
      orderId: number,
      id: number,
      params: any
    ) => Promise<ShopifyTypes.IOrderRisk>;
  };
  page: {
    count: (params?: any) => Promise<number>;
    ...
    list: (
      params?: any
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.IPage>>;
  ...
  payout: {
    ...
    list: (
      params?: any
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.IPayout>>;
  };
  policy: {
  ...
  priceRule: {
    ...
    list: (
      params?: any
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.IPriceRule>>;
  ...
  productImage: {
    ...
    create: (
      productId: number,
      params: any
    ) => Promise<ShopifyTypes.IProductImage>;
  ...
  productListing: {
    ...
    create: (
      productId: number,
      params: any
    ) => Promise<ShopifyTypes.IProductListing>;
    delete: (productId: number) => Promise<void>;
    get: (productId: number) => Promise<ShopifyTypes.IProductListing>;
    list: (
      params?: any
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.IProductListing>>;
  ...
  productResourceFeedback: {
    create: (
      productId: number,
      params: any
    ) => Promise<ShopifyTypes.IResourceFeedback>;
    list: (
      productId: number,
      params?: any
    ) => Promise<ShopifyTypes.IResourceFeedback[]>;
  ...
  productVariant: {
    ...
    create: (
      productId: number,
      params: any
    ) => Promise<ShopifyTypes.IProductVariant>;
    delete: (productId: number, id: number) => Promise<void>;
    get: (id: number, params?: any) => Promise<ShopifyTypes.IProductVariant>;
    list: (
      productId: number,
      params?: any
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.IProductVariant>>;
  ...
  province: {
    ...
    get: (
      ...
      id: number,
      params?: any
    ) => Promise<ShopifyTypes.IProvince>;
    list: (
      countryId: number,
      params?: any
    ) => Promise<ShopifyTypes.IProvince[]>;
  ...
  recurringApplicationCharge: {
    activate: (
      id: number,
      params: any
    ) => Promise<ShopifyTypes.IRecurringApplicationCharge>;
    create: (
      params: ShopifyTypes.ICreateRecurringApplicationCharge
    ) => Promise<ShopifyTypes.IRecurringApplicationCharge>;
    delete: (id: number) => Promise<void>;
    get: (
      id: number,
  ...
  redirect: {
    count: (params?: any) => Promise<number>;
    create: (
      params: ShopifyTypes.ICreateRedirect
    ) => Promise<ShopifyTypes.IRedirect>;
    delete: (id: number) => Promise<void>;
    get: (id: number, params?: any) => Promise<ShopifyTypes.IRedirect>;
    list: (
      params?: any
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.IRedirect>>;
    update: (
      id: number,
      params: ShopifyTypes.IUpdateRedirect
    ) => Promise<ShopifyTypes.IRedirect>;
  };
  refund: {
    ...
    get: (
      ...
      id: number,
      params?: any
    ) => Promise<ShopifyTypes.IRefund>;
    list: (
      orderId: number,
      params?: any
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.IRefund>>;
  };
  report: {
    ...
    list: (
      params?: any
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.IReport>>;
  ...
  scriptTag: {
    count: (params?: any) => Promise<number>;
    create: (
      params: ShopifyTypes.ICreateScriptTag
    ) => Promise<ShopifyTypes.IScriptTag>;
    delete: (id: number) => Promise<void>;
    get: (id: number, params?: any) => Promise<ShopifyTypes.IScriptTag>;
    list: (
      params?: any
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.IScriptTag>>;
    update: (
      id: number,
      params: ShopifyTypes.IUpdateScriptTag
    ) => Promise<ShopifyTypes.IScriptTag>;
  };
  shippingZone: {
  ...
  smartCollection: {
    ...
    list: (
      params?: any
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.ISmartCollection>>;
  ...
  tenderTransaction: {
    list: (
      ...
      ShopifyTypes.IPaginatedResult<ShopifyTypes.ITenderTransaction>
    >;
  };
  theme: {
  ...
  transaction: {
    ...
    create: (
      orderId: number,
      params: any
    ) => Promise<ShopifyTypes.ITransaction>;
    get: (
      orderId: number,
      id: number,
      params?: any
    ...
    list: (
      orderId: number,
      params?: any
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.ITransaction>>;
  };
  usageCharge: {
    create: (
      recurringApplicationChargeId: number,
      params: ShopifyTypes.ICreateUsageCharge
    ) => Promise<ShopifyTypes.IUsageCharge>;
    get: (
      recurringApplicationChargeId: number,
      id: number,
      params?: any
  ...
  webhook: {
    count: (params?: any) => Promise<number>;
    create: (
      params: ShopifyTypes.ICreateWebhook
    ) => Promise<ShopifyTypes.IWebhook>;
    delete: (id: number) => Promise<void>;
    get: (id: number, params?: any) => Promise<ShopifyTypes.IWebhook>;
    list: (
      params?: any
    ) => Promise<ShopifyTypes.IPaginatedResult<ShopifyTypes.IWebhook>>;
    update: (
      id: number,
      params: ShopifyTypes.IUpdateWebhook
    ) => Promise<ShopifyTypes.IWebhook>;
  };
}
...
declare namespace ShopifyTypes {
  ...
  interface ICustomCollection {
    ...
    image: IImage;
    id: number;
    metafield?: IObjectMetafield; // From https://help.ShopifyTypes.com/api/reference/customcollection but not visible in test API call
    published?: string; // From https://help.ShopifyTypes.com/api/reference/customcollection but not visible in test API call
    published_at: string;
    published_scope: string;
  ...
  interface ICustomer {
    ...
    id: number;
    last_name: string;
    metafield?: IObjectMetafield; // From https://help.ShopifyTypes.com/api/reference/customer but not visible in test API call
    phone: string;
