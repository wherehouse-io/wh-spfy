export enum EShopifyFulfillmentStatus {
  PENDING = "pending",
  OPEN = "open",
  SUCCESS = "success",
  CANCELLED = "cancelled",
...
export enum FulfillmentProviders {
  XPREESSBEES = "xpressbees",
  DTDCEXPRESS = "DTDCexpress",
  DTDCECONOMY = "DTDCeconomy",
  DTDCAIR = "DTDCAir",
  DTDCSURFACE = "DTDCSurface",
  DELHIVERY = "delhivery",
  ...
  SHIPWAY = "shipway",
  SHYPLITE_AIR = "shypliteAir",
  SHYPLITE_SURFACE = "shypliteSurface",
  SHYPLITE_LITE = "shypliteLite",
  CLICKPOST = "clickPost",
